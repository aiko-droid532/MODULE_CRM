...
const FUNNEL_STRUCTURE: FunnelItem[] = [
  ...
  { key: 'PRE_RESERVATION', label: '1-й звонок (МП)', type: 'normal' },
  { key: 'RESERVATION', label: '2-й звонок (МП)', type: 'normal' },
  { key: 'CONTRACT_PREPARATION', label: '3-й звонок (МП)', type: 'normal' },
